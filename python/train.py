...
from dataset import TranscribedAudioDataset
...
train_size = 1000
test_size = 200
dataset = TranscribedAudioDataset('./data/spoken-belgian-dutch-audio/RDH_VL/transcripts.txt', 
                                    file_fn = lambda x: x + '.wav')

check_dataset_stats(dataset)
